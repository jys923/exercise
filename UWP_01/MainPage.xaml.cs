...
namespace UWP_01
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        {
            throw new InvalidOperationException("testtest");
        }
        ...
        private async void Button0_Click(object sender, RoutedEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                System.Diagnostics.Trace.TraceError("ㄴㅁㄴㅇㅁㄴㅇ:"+ex.Message);
                System.Diagnostics.Trace.TraceError("ㄴㅁㄴㅇㅁㄴㅇ:"+ex.StackTrace);
                // Iterate over the frames extracting the information you need
                foreach (StackFrame frame in frames)
                {
                    System.Diagnostics.Debug.WriteLine("나와라:{0}:{1}({2},{3})줄번호:{4}", frame.GetFileName(), frame.GetMethod().Name, frame.GetFileLineNumber(), frame.GetFileColumnNumber(), st);
                }
